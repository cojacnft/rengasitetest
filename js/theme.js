	...
	if (typeof $('#google-recaptcha-v3').val() != "undefined") {
		grecaptcha.ready(function () {
			...
			grecaptcha.execute(site_key, {action: 'contact'}).then(function (token) {
				...
				$.ajax({
					url: 'https://docs.google.com/forms/u/6/d/e/1FAIpQLSdY3BuNZ80K_dq8rX6JdHSzQ668vbu5xv_0FxM9Su6MMkx5Og/formResponse',  // form action url
					type: 'POST', 		  // form submit method get/post
					dataType: 'json', 	  // request type html/json/xml
					data: gdata, 		  // serialize form data
					beforeSend: function () {
						submit.attr("disabled", "disabled");
						var loadingText = '<span role="status" aria-hidden="true" class="spinner-border spinner-border-sm align-self-center me-2"></span>Submitting.....'; // change submit button text
